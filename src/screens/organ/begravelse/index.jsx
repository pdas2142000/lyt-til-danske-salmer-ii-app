    ...
    return (
        <Layout {...{navigation}} ignoreStyles={true}>
            <FlatList
              ...
              onRefresh={() => {
                    LoadSongs(true, SetRequestLoading, SetRequestLoaded, SetData, UserData);
                }}
