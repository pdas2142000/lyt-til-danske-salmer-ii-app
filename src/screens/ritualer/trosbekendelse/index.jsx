/**React Imports */import React, {useState, useEffect, useContext} from 'react'
import {
    Text,
    FlatList,
    View,
...
/**Main Export */
const Trosbekendelse = ({navigation}) => {
        ...
        <Layout {...{navigation}} ignoreStyles={true}>
            <FlatList
                ...
                ListHeaderComponent={() => {
                    return (
                        <>
                            <ScreenTitle title={'Trosbekendelse'} />
                        </>
                    )
                }}
                ListEmptyComponent={() => {
